...
//#region node_modules/.nitro/vite/services/ssr/assets/router-BniRk12A.js
var router_BniRk12A_exports = /* @__PURE__ */ __exportAll({ getRouter: () => getRouter });
...
var styles_default = "/assets/styles-CWVy50C_.css";
var APP_NAME = "Data Canvas";
var Route$1 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "Drop a CSV or Excel file to see charts, figures, and a readable table. Image URLs render as pictures."
			}
		],
		links: [
			{
...
var $$splitComponentImporter = () => import("./routes-zX64Cvcm.mjs");
...
//#endregion
export { getRouter, router_BniRk12A_exports as t };
